...
const Footer = () => {
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white dark:bg-gray-800 pt-10">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        <div className="sm:col-span-2 lg:col-span-1">
          <a href="#" className="text-black dark:text-white font-bold text-3xl">
            NexFy
          </a>
